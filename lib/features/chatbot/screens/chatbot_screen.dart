...
//                           return _buildConfirmationCard(msg.bookingData!, cubit, isDark);
//                         }
...
//   }
//
//   Widget _buildConfirmationCard(Map<String, dynamic> data, ChatBotCubit cubit, bool isDark) {
//     return Container(
...
//                   ),
//                   onPressed: () => cubit.confirmBooking(data),
//                   child: Text("Confirm Appointment", style: AppTextStyles.textStyle14.copyWith(fontWeight: FontWeight.bold, color: Colors.white)),
//                 ),
//               ),
...
//                     shape: const StadiumBorder(),
//                   ),
//                   onPressed: () => cubit.sendTextMessage("Cancel booking and change the schedule"),
