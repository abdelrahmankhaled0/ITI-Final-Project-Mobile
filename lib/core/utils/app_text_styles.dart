...
class AppTextStyles {
  ...
  static const TextStyle textStyle36 = TextStyle(fontSize: 36);
  static const TextStyle textStyle30 = TextStyle(fontSize: 30);
  static const TextStyle textStyle24 = TextStyle(fontSize: 24);
  static const TextStyle textStyle22 = TextStyle(fontSize: 22);
