...
// import 'package:taborq/features/chatbot/screens/chatbot_screen.dart';
...
class AppRoutes {
  ...
  static final routes = GoRouter(
    ...
    routes: [
      ...
      // 🌟 تم نقل الشات بوت هنا (خارج الـ Shell) ليفتح Full Screen ويختفي الـ FAB تلقائياً جواه
      GoRoute(
        path: chatbot,
        builder: (context, state) => const ChatBotScreen(),
      ),
          ...
          return Scaffold(
            ...
            floatingActionButton: Padding(
              ...
              child: FloatingActionButton(
                ...
                child: const Icon(Icons.support_agent_rounded, color: AppColors.lightColor, size: 28),
              ),
            ),
          );
        },
